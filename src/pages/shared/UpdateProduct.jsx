  ...
  return (
    <Container>
      <form
        ...
        style={{
          backgroundColor: theme ? "#ADD8E6" : "#d9d9d9",
          minHeight: "500px",
        }}
      >
        <h3 className="fw-bold"> Product Update</h3>
        ...
        <div>
          <label className="bg-white file-label  py-2 px-5">
            <svg
            ...
            Update image
            <input
              className=" border-0 px-5 py-2 text-center"
              type="file"
              {...register("image")}
              accept="image/*"
            />
        ...
        <div>
          <input
            className="border-0 px-4 py-2 text-center"
            type="text"
            placeholder="Title"
        ...
        <div>
          <textarea
            className=" border-0 px-3 py-2 text-center"
